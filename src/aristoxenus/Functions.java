...
public class Functions {
    ...
    /**
     * Count the number of times the given single [character] substring occurs 
     * in the  given [string]
     */
    public static int countOccurrencesInString(String string, String character){
        int count = 0;
        for (int i = 0; i < string.length(); i++){
            if (string.substring(i) ==  character){
                count ++;
            }
        }
        return count;
    ...
    /**
     * Count the number of times the given single [character] occurs in the
     * given [string]
     */
    public static int countOccurrencesInString(String string, char character){
        int count = 0;
        for (int i = 0; i < string.length(); i++){
